...
window.CBH_MENU_DATA = {
  fallbackMenuItems: [
    ...
    // BEBIDAS
    { id: 49, cat: 'bebidas', sectionTitle: 'Bebidas', name: 'Limonada natural personal', desc: 'Elige si la quieres de limón, cereza, sandía, hierbabuena o coco.', price: 7900, icon: '🍹', optionsLabel: 'sabor', options: limonadaPersonalOptions },
    { id: 50, cat: 'bebidas', sectionTitle: 'Bebidas', name: 'Jarra Limonada Natural', desc: 'Elige el sabor de la jarra: limón, cereza, sandía, hierbabuena o coco.', price: 15900, icon: '🍹', image: './Images/limonada de sandia jarra_1_11zon.webp', imagePosition: '90% 25%', optionsLabel: 'sabor', options: limonadaJarraOptions },
    { id: 55, cat: 'bebidas', sectionTitle: 'Bebidas', name: 'Té', desc: 'Elige si lo prefieres de durazno o limón.', price: 5000, icon: '🍵' },
    { id: 56, cat: 'bebidas', sectionTitle: 'Bebidas', name: 'Gaseosa Coca-Cola', desc: 'Todas las gaseosas son Coca-Cola. Elige la presentación: 250 ml, 350 ml, 400 ml o 1.5 L.', price: 3500, icon: '🥤', optionsLabel: 'presentación', options: cocaColaOptions },

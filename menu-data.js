...
window.CBH_MENU_DATA = {
  fallbackMenuItems: [
    ...
    { id: 87, cat: 'alas', sectionTitle: 'Super alas', name: '8 alitas + Tazón de papas + ensalada', desc: 'Combo perfecto para compartir', price: 36900, icon: '🍗', image: './Images/8 alas_4_11zon.webp', imagePosition: '50% 52%' },
    { id: 88, cat: 'alas', sectionTitle: 'Super alas', name: '12 alitas + Tazón de papas + Econolitro', desc: 'Para el hambre de verdad', price: 56900, icon: '🍗', image: './Images/alitasx12_2_11zon.webp', imagePosition: '50% 95%', optionsLabel: 'sabor econolitro', options: [{ label: 'Pepsi', price: 56900 }, { label: 'Manzana', price: 56900 }, { label: 'Colombiana', price: 56900 }] },
    { id: 89, cat: 'alas', sectionTitle: 'Super alas', name: '20 alitas + Tazón de papas + Econolitro', desc: 'La opción más poderosa para compartir', price: 93900, icon: '🍗', image: './Images/20 alas_3_11zon.webp', imagePosition: '50% 72%', optionsLabel: 'sabor econolitro', options: [{ label: 'Pepsi', price: 93900 }, { label: 'Manzana', price: 93900 }, { label: 'Colombiana', price: 93900 }] },
    { id: 90, cat: 'alas', sectionTitle: 'Super alas', name: 'Burger o perro clasico + 3 alas BBQ + papas', desc: 'Combo con alas y papas', price: 28900, icon: '🍗', image: './Images/h mas 3 alas_6_11zon.webp', imagePosition: '50% 20%' },
    { id: 91, cat: 'alas', sectionTitle: 'Super alas', name: '2 Burger clasica o perro clasico + 3 alas BBQ + papas', desc: 'Combo doble con alas y papas', price: 38900, icon: '🍗' },
    ...
    // ADICIONALES
    { id: 73, cat: 'adicionales', sectionTitle: 'Adicionales', name: 'Pollo', price: 6900, icon: '➕' },
    { id: 74, cat: 'adicionales', sectionTitle: 'Adicionales', name: 'Carne', price: 6900, icon: '➕' },
    { id: 75, cat: 'adicionales', sectionTitle: 'Adicionales', name: 'Queso', price: 4900, icon: '➕' },
    { id: 76, cat: 'adicionales', sectionTitle: 'Adicionales', name: 'Tocineta', price: 4900, icon: '➕' },
    { id: 77, cat: 'adicionales', sectionTitle: 'Adicionales', name: 'Huevo frito', price: 3500, icon: '➕' },
    { id: 78, cat: 'adicionales', sectionTitle: 'Adicionales', name: 'Huevo de codorniz X6', price: 8900, icon: '➕' },
    { id: 79, cat: 'adicionales', sectionTitle: 'Adicionales', name: 'Tazon de papas', price: 9900, icon: '➕' },
    { id: 80, cat: 'adicionales', sectionTitle: 'Adicionales', name: 'Palitos de yuca', price: 9900, icon: '➕' },
    { id: 81, cat: 'adicionales', sectionTitle: 'Adicionales', name: 'Jalapeños', price: 3900, icon: '➕' },
    { id: 82, cat: 'adicionales', sectionTitle: 'Adicionales', name: 'Salchicha', price: 5900, icon: '➕' },
    { id: 83, cat: 'adicionales', sectionTitle: 'Adicionales', name: 'Chorizo', price: 5900, icon: '➕' },
    { id: 84, cat: 'adicionales', sectionTitle: 'Adicionales', name: 'Maicitos', price: 4900, icon: '➕' },
    { id: 85, cat: 'adicionales', sectionTitle: 'Adicionales', name: 'Aros de Cebolla X6', price: 9900, icon: '➕' },
